 ...
 */
public class Test extends RecyclerView.ItemAnimator {
...
//        mPendingAdditions.add(holder);
        ...
        animateMove(holder, 0, holder.itemView.getMeasuredHeight(), 0, 0);
        return true;
    }
    ...
    private void animateMoveImpl(final RecyclerView.ViewHolder holder, int fromX, int fromY, int toX, int toY) {
        ...
        final ViewPropertyAnimatorCompat animation = ViewCompat.animate(view);
        animation.setDuration(1000).setListener(new VpaListenerAdapter() {
            @Override
            public void onAnimationStart(View view) {
